...
import { SYNC_ALL_MODE, syncAllKoboSubmissionsWithMonday } from "./sync-all-kobo-submissions-with-monday";
import { errorToString, safeJsonStringify } from "./helpers";
import { PROCESS_ONE_MODE, addKoboSubmissionToMonday } from "./add-kobo-submission-to-monday";
    ...
    req: HttpRequest
        ...
        try {
            ...
            if (req.body?.[INTEGARTION_MODE_BODY_KEY] === PROCESS_ONE_MODE) {
              const response = await addKoboSubmissionToMonday(req.body.submission);
